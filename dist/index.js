...
const axios = __nccwpck_require__(416);
...
module.exports = __nccwpck_require__(726);
...
var utils = __nccwpck_require__(490);
var settle = __nccwpck_require__(66);
var buildFullPath = __nccwpck_require__(132);
var buildURL = __nccwpck_require__(114);
var http = __nccwpck_require__(685);
var https = __nccwpck_require__(687);
var httpFollow = (__nccwpck_require__(69).http);
var httpsFollow = (__nccwpck_require__(69).https);
var url = __nccwpck_require__(310);
var zlib = __nccwpck_require__(796);
var VERSION = (__nccwpck_require__(944).version);
var createError = __nccwpck_require__(200);
var enhanceError = __nccwpck_require__(157);
var transitionalDefaults = __nccwpck_require__(976);
var Cancel = __nccwpck_require__(152);
...
var utils = __nccwpck_require__(490);
var settle = __nccwpck_require__(66);
var cookies = __nccwpck_require__(405);
var buildURL = __nccwpck_require__(114);
var buildFullPath = __nccwpck_require__(132);
var parseHeaders = __nccwpck_require__(889);
var isURLSameOrigin = __nccwpck_require__(616);
var createError = __nccwpck_require__(200);
var transitionalDefaults = __nccwpck_require__(976);
var Cancel = __nccwpck_require__(152);
...
var utils = __nccwpck_require__(490);
var bind = __nccwpck_require__(659);
var Axios = __nccwpck_require__(88);
var mergeConfig = __nccwpck_require__(420);
...
axios.Cancel = __nccwpck_require__(152);
axios.CancelToken = __nccwpck_require__(582);
axios.isCancel = __nccwpck_require__(415);
axios.VERSION = (__nccwpck_require__(944).version);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(701);

// Expose isAxiosError
axios.isAxiosError = __nccwpck_require__(400);
...
var utils = __nccwpck_require__(490);
var buildURL = __nccwpck_require__(114);
var InterceptorManager = __nccwpck_require__(821);
var dispatchRequest = __nccwpck_require__(229);
var mergeConfig = __nccwpck_require__(420);
var validator = __nccwpck_require__(933);
...
var isAbsoluteURL = __nccwpck_require__(449);
...
var utils = __nccwpck_require__(490);
var transformData = __nccwpck_require__(368);
var isCancel = __nccwpck_require__(415);
var defaults = __nccwpck_require__(591);
var Cancel = __nccwpck_require__(152);
...
var utils = __nccwpck_require__(490);
var normalizeHeaderName = __nccwpck_require__(730);
var enhanceError = __nccwpck_require__(157);
var transitionalDefaults = __nccwpck_require__(976);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(858);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(80);
  }
  return adapter;
}
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(622)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(407);
...
const log = __nccwpck_require__(49);
...
const main = async () => {
    try {
        ...
        await __nccwpck_require__(376)(directory, branch, { token, organizationId, userId }, { directory, name, spec, files, classifier, subType });
    } catch (error) {
